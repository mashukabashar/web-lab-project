...
if(isset($_POST['submit']))
{
	...
	if(!$con) {
		...
		if(mysqli_num_rows($table_check) == 0) {
			$error_message = "Admin table not found. Please contact administrator.";
		} else {
...
<body>
	...
	<div class="footer">
		<div class="container">
			...
			<div style="background: #f8d7da; color: #721c24; border: 1px solid #f5c6cb; border-radius: 5px; padding: 15px; margin: 20px 0; text-align: center;">
				<strong>Login Error:</strong> <?php echo htmlspecialchars($error_message); ?>
			</div>
			<?php endif; ?>
			...
			<div style="background: #d1ecf1; border: 1px solid #bee5eb; border-radius: 5px; padding: 15px; margin: 20px 0; text-align: center;">
				...
				<p><strong>Username:</strong> Drashti | <strong>Password:</strong> sabhaya</p>
			</div>
	...
	<div class="footer">
		...
		<div class="copy-right w3-agile-text">
			<div class="container">
				...
				<p>© 2017 EventEase, Rajkot. All rights reserved | Design by Drashti</p>	
			</div>
		</div>
		<!-- //copy-right -->
	</div>
